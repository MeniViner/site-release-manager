import { SP_ERROR } from './sharepointErrors.js';
...
export function userFacingSharePointFailure(value = {}) {
...
export function sanitizeReleaseDiagnostic(value) {
  return String(value ?? '')
    .replace(/<[^>]*>/g, '[html]')
...
export function safeReleaseManagerError(error, fallback = 'הפעולה נכשלה. נסו שוב או פתחו את האבחון לקבלת פרטים.') {
