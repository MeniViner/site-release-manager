...
export function resumeStage(events = [], pipeline = null) {
  const order = pipeline || [
    ...
    STAGE.CREATE_LIBRARIES, STAGE.LIBRARY_STABILIZE, STAGE.CREATE_FOLDERS, STAGE.FOLDER_STABILIZE,
    STAGE.CREATE_TXT_SEEDS, STAGE.PERMISSIONS_SETUP, STAGE.FINAL_ASSET_COPY, STAGE.FINAL_ASSET_VERIFY,
    STAGE.FINAL_INDEX_COMMIT, STAGE.FINAL_INDEX_VERIFY, STAGE.FINAL_APP_SMOKE, STAGE.COMPLETE,
  ];
