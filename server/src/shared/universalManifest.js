...
const MANIFEST_FILE = 'sharepoint-deploy-manifest.json';
const RUNTIME_CONFIG_FILE = 'sitebuilder-runtime-config.json';
const DEPLOYMENT_METADATA_FILE = 'sitebuilder-deployment.json';
 ...
 */
const RUNTIME_BOOTSTRAP_FILE = 'sitebuilder-runtime-bootstrap.js';

/** Files Release Manager generates per target. They must never ship inside a release. */
const TARGET_OVERLAY_FILES = Object.freeze([
  RUNTIME_CONFIG_FILE,
  DEPLOYMENT_METADATA_FILE,
  RUNTIME_BOOTSTRAP_FILE,
]);

const MANIFEST_KIND = 'sitebuilder-release-manifest';
const UNIVERSAL_BUILD_MODE = 'universal';
const UNIVERSAL_ARTIFACT_KIND = 'site-builder-universal-frontend';
const ENTRY_POINT = 'index.html';
const COMMIT_FILE = 'index.html';
 ...
 */
const SUPPORTED_MANIFEST_SCHEMA_VERSIONS = Object.freeze([2, 3, 4]);
const CURRENT_MANIFEST_SCHEMA_VERSION = 4;
...
function parseIndexReferencesFromHtml(html) {
...
module.exports = {
  validateUniversalManifest: validateUniversalManifest,
  parseIndexReferencesFromHtml: parseIndexReferencesFromHtml,
  MANIFEST_FILE: MANIFEST_FILE,
  RUNTIME_CONFIG_FILE: RUNTIME_CONFIG_FILE,
  DEPLOYMENT_METADATA_FILE: DEPLOYMENT_METADATA_FILE,
  RUNTIME_BOOTSTRAP_FILE: RUNTIME_BOOTSTRAP_FILE,
  TARGET_OVERLAY_FILES: TARGET_OVERLAY_FILES,
  MANIFEST_KIND: MANIFEST_KIND,
  UNIVERSAL_BUILD_MODE: UNIVERSAL_BUILD_MODE,
  UNIVERSAL_ARTIFACT_KIND: UNIVERSAL_ARTIFACT_KIND,
  ENTRY_POINT: ENTRY_POINT,
  COMMIT_FILE: COMMIT_FILE,
  SUPPORTED_MANIFEST_SCHEMA_VERSIONS: SUPPORTED_MANIFEST_SCHEMA_VERSIONS,
  CURRENT_MANIFEST_SCHEMA_VERSION: CURRENT_MANIFEST_SCHEMA_VERSION,
};
