 ...
 */
const TXT_DATA_FILES = Object.freeze([
...
class SiteIdentityError extends Error {
  constructor(message) {
    super(message);
...
function normalizeSegment(value, fallback, label) {
 ...
 */
function buildSiteIdentity(site = {}) {
 ...
 */
function canonicalTargetKey(identity) {
...
function txtFilePath(identity, definition) {
 ...
 */
const TXT_SEED_CONTENT = Object.freeze({
...
function buildTxtSeedPlan(identity) {
 ...
 */
function requiredLibraries(identity) {
  return [
...
function requiredFolders(identity, extraDistFolders = []) {
  const base = [
    identity.siteAssetsRoot,
    identity.imagesRoot,
...
module.exports = {
  SiteIdentityError: SiteIdentityError,
  normalizeSegment: normalizeSegment,
  buildSiteIdentity: buildSiteIdentity,
  canonicalTargetKey: canonicalTargetKey,
  txtFilePath: txtFilePath,
  buildTxtSeedPlan: buildTxtSeedPlan,
  requiredLibraries: requiredLibraries,
  requiredFolders: requiredFolders,
  RUNTIME_DEFAULTS: RUNTIME_DEFAULTS,
  TXT_DATA_FILES: TXT_DATA_FILES,
  TXT_SEED_CONTENT: TXT_SEED_CONTENT,
};
