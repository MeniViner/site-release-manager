 ...
 */
const RETRYABLE_CLASSES = Object.freeze([SP_ERROR.TRANSIENT_NOT_READY]);
 ...
 */
const NOT_READY_CLASSES = Object.freeze([SP_ERROR.MISSING, SP_ERROR.TRANSIENT_NOT_READY]);
 ...
 */
function parseSharePointErrorPayload(body) {
 ...
 */
function classifySharePointError(input = {}) {
...
function isNotReady(errorClass) {
...
function sharePointError(record, fallbackMessage = 'SharePoint request failed') {
...
module.exports = {
  parseSharePointErrorPayload: parseSharePointErrorPayload,
  classifySharePointError: classifySharePointError,
  isNotReady: isNotReady,
  isRetryable: isRetryable,
  sharePointError: sharePointError,
  SP_ERROR: SP_ERROR,
  RETRYABLE_CLASSES: RETRYABLE_CLASSES,
  NOT_READY_CLASSES: NOT_READY_CLASSES,
  SP_CODES: SP_CODES,
};
