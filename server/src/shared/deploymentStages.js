...
const SERVER_STAGES = Object.freeze([
  STAGE.RELEASE_VALIDATE,
  STAGE.TARGET_VALIDATE,
  STAGE.STAGING_CREATE,
  STAGE.RUNTIME_CONFIG_CREATE,
...
const BROWSER_MUTATION_STAGES = Object.freeze([
  STAGE.CREATE_LIBRARIES,
  STAGE.PRE_DEPLOY_BACKUP,
  STAGE.CREATE_FOLDERS,
  STAGE.CREATE_TXT_SEEDS,
...
const SIDE_STAGES = Object.freeze(['LOCAL_AUDIT']);
...
function stageAtOrAfter(candidate, reference) {
...
module.exports = {
  ...
  stageAtOrAfter: stageAtOrAfter,
  STAGE: STAGE,
  STAGE_ORDER: STAGE_ORDER,
  SERVER_STAGES: SERVER_STAGES,
  BROWSER_MUTATION_STAGES: BROWSER_MUTATION_STAGES,
  STAGE_LABELS: STAGE_LABELS,
  LEGACY_STAGE_ALIASES: LEGACY_STAGE_ALIASES,
  SIDE_STAGES: SIDE_STAGES,
};
