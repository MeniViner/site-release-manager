...
const { SP_ERROR, classifySharePointError, isNotReady, isRetryable } = require("./sharepointErrors.js");
...
const STABILIZE_RETRY = Object.freeze({
  initialDelayMs: 600,
  maxDelayMs: 6000,
  factor: 1.7,
  maxAttempts: 14,
 ...
 */
function backoffDelays(options = {}) {
 ...
 */
async function stabilize(verify, options = {}) {
...
module.exports = {
  ...
  STABILIZE_RETRY: STABILIZE_RETRY,
};
